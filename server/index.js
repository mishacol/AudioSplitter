...
// MAIN BRANCH FORMAT SELECTION FUNCTION
...
app.get('/stream', async (req, res) => {
  ...
  try {
    // MAIN BRANCH APPROACH: Use yt-dlp directly in Node.js (NO Python backend)
    ...
    if (isDirectUrl) {
      ...
      // Resolve to a direct audio URL first - MAIN BRANCH APPROACH
      try {
